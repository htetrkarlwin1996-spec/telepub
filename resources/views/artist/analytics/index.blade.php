            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="text-xs font-extrabold uppercase tracking-wider text-black/50">Total Revenue</span>
                    </div>
                ...
                <div class="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="text-xs font-extrabold uppercase tracking-wider text-black/50">Total Downloads</span>
                    </div>
                    <div class="text-3xl font-black text-black">{{ number_format($totalDownloads) }}</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] lg:col-span-2">
                    <div class="p-6 border-b-2 border-black">
                        <h3 class="font-extrabold text-lg text-black tracking-tight">Monthly Performance (Last 12 Months)</h3>
                    </div>
                    <div class="p-6">
