        ...
        <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('artist.catalog.store-step2', $album) }}" enctype="multipart/form-data">
                ...
                <div class="flex items-center justify-between mt-8">
                    <a href="{{ route('artist.catalog.create') }}" class="px-6 py-3 bg-gray-200 border-2 border-black font-extrabold text-sm uppercase hover:bg-gray-300 transition-all">
                        ← Back
                    </a>
        ...
        document.getElementById('add-track').addEventListener('click', function() {
            ...
            personLists.forEach(list => {
                ...
                if (field === 'primary_artists' || field === 'composers') {
                    ...
                    // Remove all entries for optional fields
