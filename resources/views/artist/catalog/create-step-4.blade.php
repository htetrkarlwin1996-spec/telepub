    ...
    <div class="min-h-screen bg-[#FFF8E7]">
        <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-sm font-bold text-black/60 text-center mt-1">Choose where to distribute your release: <span class="text-brand-600">{{ $album->title }}</span></p>
            </div>
            ...
            <form method="POST" action="{{ route('artist.catalog.store-step4', $album) }}">
                ...
                <div class="flex items-center justify-between mt-8">
                    <a href="{{ route('artist.catalog.step3', $album) }}" class="px-6 py-3 bg-gray-200 border-2 border-black font-extrabold text-sm uppercase hover:bg-gray-300 transition-all">
                        ← Back to Pricing
                    </a>
