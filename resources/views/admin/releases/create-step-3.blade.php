<x-app-layout>
    <div class="min-h-screen bg-[#FFF8E7]">
        <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.releases.store-step3', $album) }}" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('admin.releases.step2', $album) }}" class="px-6 py-3 bg-gray-200 border-2 border-black font-extrabold text-sm uppercase hover:bg-gray-300 transition-all">
                        ← Back to Tracks
                    </a>
