                ...
                <div class="bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title', $album->title) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('title') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <select name="release_type" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('release_type') border-red-500 @enderror" required>
                                <option value="single" {{ old('release_type', $album->release_type) == 'single' ? 'selected' : '' }}>Single</option>
                                <option value="ep" {{ old('release_type', $album->release_type) == 'ep' ? 'selected' : '' }}>EP</option>
                                <option value="album" {{ old('release_type', $album->release_type) == 'album' ? 'selected' : '' }}>Album</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select name="genre" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('genre') border-red-500 @enderror" required>
                                ...
                                @foreach($genres as $genre)
                                    <option value="{{ $genre }}" {{ old('genre', $album->genre) == $genre ? 'selected' : '' }}>{{ $genre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="label" value="{{ old('label', $album->label) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('label') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="date" name="release_date" value="{{ old('release_date', $album->release_date?->format('Y-m-d')) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('release_date') border-red-500 @enderror" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="upc_code" value="{{ old('upc_code', $album->upc_code) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('upc_code') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="copyright_holder" value="{{ old('copyright_holder', $album->copyright_holder) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('copyright_holder') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="phonogram_right_holder" value="{{ old('phonogram_right_holder', $album->phonogram_right_holder) }}" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('phonogram_right_holder') border-red-500 @enderror">
                            @error('phonogram_right_holder') <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-xs font-extrabold uppercase text-black/60 mb-1">Status</label>
                            <select name="status" class="w-full border-2 border-black px-3 py-2 text-sm font-bold focus:outline-none focus:ring-0 focus:border-brand-500 @error('status') border-red-500 @enderror" required>
                                <option value="draft" {{ old('status', $album->status) == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="submitted" {{ old('status', $album->status) == 'submitted' ? 'selected' : '' }}>Submitted</option>
                                <option value="approved" {{ old('status', $album->status) == 'approved' ? 'selected' : '' }}>Approved</option>
                                <option value="rejected" {{ old('status', $album->status) == 'rejected' ? 'selected' : '' }}>Rejected</option>
                            </select>
