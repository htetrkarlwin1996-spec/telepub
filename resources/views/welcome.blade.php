...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#F4F4F0] text-[#000000] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
            ...
            @if (Route::has('login'))
                <nav class="flex items-center justify-end gap-4">
                    @auth
                        <a
                            href="{{ url('/dashboard') }}"
                            class="inline-block px-5 py-1.5 border-2 border-black text-black font-bold text-sm leading-normal hover:bg-brand-500 transition-all"
                        >
                            Dashboard
                        </a>
                    @else
                        <a
                            href="{{ route('login') }}"
                            class="inline-block px-5 py-1.5 text-black font-bold border-2 border-transparent hover:border-black transition-all text-sm leading-normal"
                        >
                            Log in
                        </a>
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-sm leading-6 flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] font-semibold text-black">
                    <h1 class="mb-1 font-black text-lg">Let's get started</h1>
                    <p class="mb-2 text-black/60 font-semibold">With so many options available to you,<br /> we suggest you start with the following:</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-black/10 before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            <span class="relative py-1 bg-white">
                                <span class="flex items-center justify-center rounded-full bg-white border-2 border-black w-3.5 h-3.5">
                                    <span class="rounded-full bg-black w-1.5 h-1.5"></span>
                                </span>
                            </span>
                            <span>
                                Read the
                                <a href="https://laravel.com/docs" target="_blank" class="inline-flex items-center space-x-1 font-extrabold underline decoration-brand-500 decoration-2 underline-offset-2 hover:decoration-black text-black ml-1">
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-black/10 before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                            <span class="relative py-1 bg-white">
                                <span class="flex items-center justify-center rounded-full bg-white border-2 border-black w-3.5 h-3.5">
                                    <span class="rounded-full bg-black w-1.5 h-1.5"></span>
                                </span>
                            ...
                            <span>
                                ...
                                <a href="https://laracasts.com" target="_blank" class="inline-flex items-center space-x-1 font-extrabold underline decoration-brand-500 decoration-2 underline-offset-2 hover:decoration-black text-black ml-1">
                                    <span>Laracasts</span>
                                    <svg
                                        width="10"
                                        height="11"
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="https://cloud.laravel.com" target="_blank" class="inline-block px-5 py-1.5 bg-brand-500 border-2 border-black text-black font-extrabold text-sm leading-normal hover:bg-brand-400 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] transition-all">
                                Deploy now
                            </a>
                        </li>
                    </ul>

                    <p class="mt-6 lg:mt-10 text-black/60 font-semibold">
                        v{{ app()->version() }}
                        <a href="https://github.com/laravel/framework/blob/13.x/CHANGELOG.md" target="_blank" class="inline-flex items-center space-x-1 font-extrabold underline decoration-brand-500 decoration-2 underline-offset-2 hover:decoration-black text-black ml-1">
                ...
                <div class="bg-brand-500 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden border-2 border-black">
                    {{-- Laravel Logo --}}
                    <svg class="w-full text-black transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 motion-safe:starting:translate-y-6" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- 13 --}}
                    <svg class="w-[438px] max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 [--stroke-color:#000000]" viewBox="0 0 440 392" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g class="mix-blend-darken transition-all delay-300 opacity-100 duration-750 starting:opacity-0 text-black">
                        ...
                        <g class="transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[26px] text-black/40">
                        ...
                        <g class="mix-blend-color transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[51px] text-black/60">
                        ...
                        <g class="mix-blend-multiply transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[78px] text-black/40">
                        ...
                        <g class="mix-blend-hard-light transition-all delay-400 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-[102px] text-black/40">
                    ...
                    <div class="absolute inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg border-2 border-black pointer-events-none"></div>
                </div>
            </main>
        </div>
